...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../project_1_HelloWorld.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../project_1_HelloWorld.gen/sources_1/bd/design_1/ipshared/ee60/hdl" \
       +incdir+"../../../../project_1_HelloWorld.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../project_1_HelloWorld.gen/sources_1/bd/design_1/ipshared/ee60/hdl" \
       +incdir+"R:/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
       -input simulate.do
}
